...
- [tutorial.djangogirls.org](https://tutorial.djangogirls.org/) – Building an interactive Django website
- [polars go undersea](https://www.academis.eu/polars_go_undersea/) – Data analysis with polars – by **Shreyaasri Prakash and Kristian Rother**
- [pandas go to space](https://www.academis.eu/pandas_go_to_space/) – Data analysis with pandas – by **Kristian Rother**
- [Pixels to generative AI](https://pixels2genai.art) – Creating art with NumPy and neural networks by **Burak Kağan Yılmazer and Kristian Rother**
